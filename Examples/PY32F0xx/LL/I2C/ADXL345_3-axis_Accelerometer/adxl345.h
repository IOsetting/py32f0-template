...
#define ADXL345_DEFAULT_ADDRESS     (0xA6) // 0xA6(SDO->GND), 0x3A(SDO->VCC)
...
/**
 * @brief Output Data Rate, Used with register 0x2C (ADXL345_REG_BW_RATE) to set bandwidth.
 *        The maximum output data rate when using 400 kHz I2C is 800 Hz and scales linearly 
 *        with a change in the I2C communication speed. For example, using I2C at 100 kHz 
 *        would limit the maximum ODR to 200 Hz
*/
typedef enum {
