...
*/
uint8_t NRF24L01_ReadToBuf(uint8_t reg, uint8_t *buf, uint8_t len)
{
    CSN_LOW;
...
*/
uint8_t NRF24L01_WriteFromBuf(uint8_t reg, const uint8_t *buf, uint8_t len)
{
    CSN_LOW;
    uint8_t status = SPI_TxRxByte(reg);
    while (len--)
...
uint8_t NRF24L01_Check(void)
{
    ...
    NRF24L01_WriteFromBuf(NRF24L01_CMD_W_REGISTER | NRF24L01_REG_TX_ADDR, ptr, 5);
    NRF24L01_ReadToBuf(NRF24L01_CMD_R_REGISTER | NRF24L01_REG_TX_ADDR, rxbuf, 5);
...
{
    NRF24L01_WriteReg(NRF24L01_REG_STATUS, NRF24L01_FLAG_MAX_RT); // Clear max retry flag
    CE_LOW;
    CE_HIGH;
}
...
{
    // TX Address
    NRF24L01_WriteFromBuf(NRF24L01_CMD_W_REGISTER + NRF24L01_REG_TX_ADDR, tx_addr, NRF24L01_ADDR_WIDTH);
    // RX P0 Payload Width
    NRF24L01_WriteReg(NRF24L01_REG_RX_PW_P0, NRF24L01_PLOAD_WIDTH);
    // Enable Auto ACK
    NRF24L01_WriteReg(NRF24L01_REG_EN_AA, 0x3f);
    // Enable RX channels
    NRF24L01_WriteReg(NRF24L01_REG_EN_RXADDR, 0x3f);
    // RF channel: 2.400G  + 0.001 * x
    NRF24L01_WriteReg(NRF24L01_REG_RF_CH, 40);
    ...
    NRF24L01_WriteReg(NRF24L01_REG_RF_SETUP, 0x03);
    // 0A:delay=250us,count=10, 1A:delay=500us,count=10
    NRF24L01_WriteReg(NRF24L01_REG_SETUP_RETR, 0x0a);
}
...
void NRF24L01_RX_Mode(uint8_t *rx_addr, uint8_t *tx_addr)
{
    ...
    // RX Address of P0
    NRF24L01_WriteFromBuf(NRF24L01_CMD_W_REGISTER + NRF24L01_REG_RX_ADDR_P0, rx_addr, NRF24L01_ADDR_WIDTH);
    /**
    REG 0x00: 
    0)PRIM_RX     0:TX             1:RX
    1)PWR_UP      0:OFF            1:ON
    ...
    7)Reserved    0
    */
    NRF24L01_WriteReg(NRF24L01_REG_CONFIG, 0x0f); //RX,PWR_UP,CRC16,EN_CRC
    CE_HIGH;
    NRF24L01_FlushRX();
}
...
void NRF24L01_TX_Mode(uint8_t *rx_addr, uint8_t *tx_addr)
{
    ...
    NRF24L01_WriteFromBuf(NRF24L01_CMD_W_REGISTER + NRF24L01_REG_RX_ADDR_P0, tx_addr, NRF24L01_ADDR_WIDTH);
    NRF24L01_WriteReg(NRF24L01_REG_CONFIG, 0x0e); //TX,PWR_UP,CRC16,EN_CRC
    CE_HIGH;
}

uint8_t NRF24L01_RX_GetPayloadWidth(void)
{
    return NRF24L01_ReadReg(NRF24L01_CMD_R_RX_PL_WID);
}
...
uint8_t NRF24L01_TxPacket(uint8_t *tx_buf, uint8_t len)
{
    ...
    NRF24L01_WriteFromBuf(NRF24L01_CMD_W_TX_PAYLOAD, tx_buf, len);
    CE_HIGH;
...
{
    NRF24L01_WriteFromBuf(NRF24L01_CMD_W_TX_PAYLOAD, pBuf, len);
    CE_HIGH;
}
...
{
    NRF24L01_WriteReg(NRF24L01_CMD_ACTIVATE, 0x73);
}

void NRF24L01_SetEnableDynamicPayloads(uint8_t mode)
{
    uint8_t reg = NRF24L01_ReadReg(NRF24L01_REG_FEATURE);
    if (mode == 0)
    {
        // Disable dynamic payload throughout the system
        NRF24L01_WriteReg(NRF24L01_REG_FEATURE, reg & (~NRF24L01_FEATURE_EN_DPL));
        // If it didn't work, the features are not enabled
        reg = NRF24L01_ReadReg(NRF24L01_REG_FEATURE);
        ...
        NRF24L01_WriteReg(NRF24L01_REG_DYNPD, 0);
    }
    else
    {
        NRF24L01_WriteReg(NRF24L01_REG_FEATURE, reg | NRF24L01_FEATURE_EN_DPL);
        ...
        NRF24L01_WriteReg(NRF24L01_REG_DYNPD, NRF24L01_DYNPD_DPL_P0 | NRF24L01_DYNPD_DPL_P1
...
void NRF24L01_SetEnableAckPayload(uint8_t mode)
{
    ...
    if (mode == 0)
    {
        ...
        NRF24L01_WriteReg(NRF24L01_REG_FEATURE, reg &(~NRF24L01_FEATURE_EN_ACK_PAY));
        // If it didn't work, the features are not enabled
        reg = NRF24L01_ReadReg(NRF24L01_REG_FEATURE);
    ...
    else
    {
        ...
        reg = NRF24L01_ReadReg(NRF24L01_REG_DYNPD);
        NRF24L01_WriteReg(NRF24L01_REG_DYNPD, reg | NRF24L01_DYNPD_DPL_P0 | NRF24L01_DYNPD_DPL_P1);
    }
}
...
void NRF24L01_DumpConfig(void) {
    ...
    // EN_AA
    i = NRF24L01_ReadReg(NRF24L01_REG_EN_AA);
    ...
    // EN_RXADDR
    i = NRF24L01_ReadReg(NRF24L01_REG_EN_RXADDR);
    ...
    // SETUP_RETR
    i = NRF24L01_ReadReg(NRF24L01_REG_SETUP_RETR);
    ...
    // RF_CH
    i = NRF24L01_ReadReg(NRF24L01_REG_RF_CH);
    printf("[0x%02X] 0x%02X (%.3uGHz)\r\n",NRF24L01_REG_RF_CH,i,2400 + i);
    // RF_SETUP
    i = NRF24L01_ReadReg(NRF24L01_REG_RF_SETUP);
    ...
    printf("dBm\r\n");
    // STATUS
    i = NRF24L01_ReadReg(NRF24L01_REG_STATUS);
    ...
    // OBSERVE_TX
    i = NRF24L01_ReadReg(NRF24L01_REG_OBSERVE_TX);
    printf("[0x%02X] 0x%02X PLOS_CNT=%u ARC_CNT=%u\r\n",NRF24L01_REG_OBSERVE_TX,i,i >> 4,i & 0x0F);

    // RPD
    i = NRF24L01_ReadReg(NRF24L01_REG_RPD);
    ...
    i = NRF24L01_ReadReg(NRF24L01_REG_RX_ADDR_P2);
    printf("%X\"\r\n",i);

    // RX_ADDR_P3
    printf("[0x%02X] RX_ADDR_P3 \"",NRF24L01_REG_RX_ADDR_P3);
    for (i = 0; i < aw - 1; i++) printf("%X ",buf[i]);
    i = NRF24L01_ReadReg(NRF24L01_REG_RX_ADDR_P3);
    printf("%X\"\r\n",i);

    // RX_ADDR_P4
    printf("[0x%02X] RX_ADDR_P4 \"",NRF24L01_REG_RX_ADDR_P4);
    for (i = 0; i < aw - 1; i++) printf("%X ",buf[i]);
    i = NRF24L01_ReadReg(NRF24L01_REG_RX_ADDR_P4);
    printf("%X\"\r\n",i);

    // RX_ADDR_P5
    printf("[0x%02X] RX_ADDR_P5 \"",NRF24L01_REG_RX_ADDR_P5);
    for (i = 0; i < aw - 1; i++) printf("%X ",buf[i]);
    i = NRF24L01_ReadReg(NRF24L01_REG_RX_ADDR_P5);
    printf("%X\"\r\n",i);
