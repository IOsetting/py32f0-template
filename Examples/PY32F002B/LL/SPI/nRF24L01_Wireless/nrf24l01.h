...
#define CSN_HIGH    LL_GPIO_SetOutputPin(GPIOB, LL_GPIO_PIN_5)
#define CSN_LOW     LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_5)
#define CE_HIGH     LL_GPIO_SetOutputPin(GPIOB, LL_GPIO_PIN_4)
#define CE_LOW      LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_4)
#define IRQ         READ_BIT(GPIOB->IDR, LL_GPIO_PIN_3)
