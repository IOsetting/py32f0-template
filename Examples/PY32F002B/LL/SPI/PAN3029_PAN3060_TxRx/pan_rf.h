 ...
 */
#define SPI_CS_HIGH()      LL_GPIO_SetOutputPin(GPIOB, LL_GPIO_PIN_5)     /* Pull SPI_CS pin high */
#define SPI_CS_LOW()       LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_5)   /* Pull SPI_CS pin low */
 ...
 */
#define CHECK_RF_IRQ()  LL_GPIO_IsInputPinSet(GPIOB, LL_GPIO_PIN_3)
 ...
 */
#define CHECK_RF_CAD()  LL_GPIO_IsInputPinSet(GPIOA, LL_GPIO_PIN_2)
 ...
 */
#define RF_RESET_PIN_LOW()   LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_4) /* Set reset pin to low level */
#define RF_RESET_PIN_High()  LL_GPIO_SetOutputPin(GPIOB, LL_GPIO_PIN_4)   /* Set reset pin to high level */
