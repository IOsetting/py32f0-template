 ...
 *   This demo will switch PC0 from NRST to GPIO
 * 
 * 
 ******************************************************************************
 */
...
int main(void)
{
  ...
  */
  ...
  // check if bit[13,14] == 0B10
  if (READ_BIT(FLASH->OPTR, OB_USER_SWD_NRST_MODE) != FLASH_OPTR_NRST_MODE)
  {
    printf("PC0/NRST hasn't been configurated as GPIO\r\n");
    /* Write option byte */
    APP_FlashSetOptionByte();
  }
  else
  {
    printf("PC0/NRST has been configurated as GPIO\r\n");
  }
